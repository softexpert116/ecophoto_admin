									...
									<div class="panel-body">
										<div class="widget-summary">
											<div class="widget-summary-col">
												<div class="summary">
													<p style="color:red; font-size:20px;">Get Photo</p>
													<div class="info">
														...
														<div class="row">
															...
															<div class="col-sm-6">
																<button id="btn_photo" class="btn btn-primary" style="width:100px;" >Run</button>
															</div>
														</div>
														<hr>
								...
								<section class="panel panel-featured-left panel-featured-primary">
									<div class="panel-body">
										<div class="widget-summary">
											<div class="widget-summary-col">
												<div class="summary">
													<p style="color:red; font-size:20px;">Get Photos By School Code</p>
													<div class="info">
														<p style="font-size:15px;">Request</p>
														<div class="row">
															<div class="col-sm-6">
															...
															<div class="col-sm-6">
																<button id="btn_photo_school" class="btn btn-primary" style="width:100px;" >Run</button>
															</div>
														</div>
														<hr>
														<p style="font-size:15px;">Reponse (base64 encoded string)</p>
