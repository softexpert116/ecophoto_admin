...
<link rel="stylesheet" href="<?php echo base_url(); ?>/assets/backend/mybuild/css/demo.css">
						...
						<div class="col-md-12">
							<section class="panel">
								<div class="panel-body">
									<a class="modal-with-form m_add" href="#add_modal"><i class="fa fa-plus" aria-hidden="true"></i>&nbspAdd New School</a>
									<br/>
									<br/>
									<table class="table table-bordered table-striped mb-none" id="datatable-default">
										<thead>
											<tr>
												...
												<th class="center">DERN</th>
												<th class="center">IEP</th>
										...
										<tbody>
											...
											<tr class="gradeX">
												...
												<td class="center">
													...
													<a class="" href="<?php echo base_url()?>admin/school_students/<?php echo $data[$i]['code'] ?>" style="color: green;">STUDENTS</a> &nbsp|&nbsp
															...
															<footer class="panel-footer">
																<div class="row">
																	<div class="col-md-12 text-right">
																		<a class="btn btn-primary delete_school_btn" data-value="<?php echo $data[$i]['code'] ?>" >Confirm</a>
			...
			<section class="panel">
				...
				<div class="panel-body">
					<form id="add-form" action="#" method="post" class="form-horizontal mb-lg" >
						...
						<div class="form-group">
							<label class="col-sm-3 control-label">DERN</label>
							<div class="col-sm-9">
								<input id="add_dern" type="text" name="add_dern" class="form-control" placeholder="Type DERN..."/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">IEP</label>
							<div class="col-sm-9">
						...
						<div class="form-group mt-lg">
							...
							<div class="col-sm-3">
								<button type="button" class="btn btn-success" id="add_generate_digits" class="form-control" style="width: 100%">Generate</button>
							</div>
						</div>
		...
		<div id="edit_modal" class="modal-block modal-block-primary mfp-hide">
			<section class="panel">
				<header class="panel-heading">
					<h2 class="panel-title">Edit School</h2>
				</header>
				<div class="panel-body">
