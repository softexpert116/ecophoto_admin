				...
				<section role="main" class="content-body">
						...
						<div class="col-md-12">
							<section class="panel">
								<div class="panel-body">
									<h2 class="panel-title mt-md" style="display: inline; vertical-align: middle;">Students By School</h2>
									<br/><br/>
									<div class="col-lg-12">
					...
					<div class="row">
						<div class="col-md-12">
							<section class="panel">
								<div class="panel-body">
									<h2 class="panel-title mt-md" style="display: inline; vertical-align: middle;">Photos taken by User</h2>
									<br/><br/>
									<div class="col-lg-12">
