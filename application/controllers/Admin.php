...
class Admin extends CI_Controller
{
    ...
    function go_dashboard($month = '')
    {
        ...
        $this->load->view('header', array('page' => 'dashboard')); //var_dump($data);
    ...
    function go_users()
    {
        ...
        $this->load->view('header', array('page' => 'users'));
    ...
    function go_schools()
    {
        ...
        $this->load->view('header', array('page' => 'schools'));
    ...
    function go_students()
    {
        ...
        $sum = 0;
        $this->load->view('header', array('page' => 'students'));
    ...
    function go_api()
    {
        $this->load->view('header', array('page' => 'api'));
    ...
    function school_students($school_code)
    {
        ...
        $this->load->view('header', array('page' => 'school_students'));
        $this->load->view('admin/school_students', array('data' => $data['data'], 'school_code' => $school_code, 'school_name' => $school_name));
    }
